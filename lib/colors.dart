...
const Color kFixalfaGreen50 = Color(0xfff0f7f3);
const Color kFixalfaGreen100 = Color(0xff62db9a);
...
const kFixalfaSurfaceWhite = const Color(0xFFf8fbf9);
const kFixalfaBackgroundWhite = Colors.white;
